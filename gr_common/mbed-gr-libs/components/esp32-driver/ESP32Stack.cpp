...
#ifdef ARDUINO
ESP32Stack::ESP32Stack(uint8_t tx, uint8_t rx, bool debug)
{
#if defined(TARGET_GR_LYCHEE)
    _esp = ESP32::getESP32Inst(P5_3, P3_14, int2PinName(tx), int2PinName(rx), debug, NC, NC, 1000000);
#else // GR-PEACH
    _esp = ESP32::getESP32Inst(P3_10, P3_9, int2PinName(tx), int2PinName(rx), debug, NC, NC, 1000000);
#endif
}
#endif
